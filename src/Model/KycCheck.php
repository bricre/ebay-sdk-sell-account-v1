...
class KycCheck extends AbstractModel
{
     ...
     * <b>detailMessage</b> and other applicable, corresponding fields. For
     ...
     * resolve the KYC requirement.<br><br>The timestamp in this field uses the UTC
     * date and time format described in the <a
     * href="https://www.iso.org/iso-8601-date-and-time-format.html"
     * target="_blank">ISO 8601 Standard</a>. See below for this format and an example:
     * <br><br><i>MM-DD-YYYY HH:MM:SS</i><br/><code>06-05-2020 10:34:18</code>.
     *
     * @var string
     */
    public $dueDate = null;
     ...
     * might be, '<code>Upload bank document now.</code>'. The <b>detailMessage</b>
     * field will often provide more details on what is required of the seller.
     *
     * @var string
     */
    public $alert = null;
     ...
     * example might be, '<code>Please upload a bank document by 2020-08-01 to get your
     * account back in good standing.</code>'.
     *
     * @var string
     */
